...
export default function MessagesPage() {
  ...
  return (
    <div className="flex h-[calc(100dvh-120px)] max-h-[calc(100dvh-120px)] min-h-[420px] bg-cyber-black/40 border border-white/5 rounded-xl overflow-hidden backdrop-blur-sm">
      {/* Sidebar */}
